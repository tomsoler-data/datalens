...
from app.adaptation import (
    greenhouse_final_acceptance_runner_v0_4_v0_3 as runner,
)


GREENHOUSE_FINAL_ACCEPTANCE_LAUNCHER_RULE_VERSION = (
    "qlora_v0.4_greenhouse_final_acceptance_launcher_v0.1"
)
...
EXPECTED_RUNNER_SHA256 = (
    "24fa4598ef89017cbac3533180494e3db6cab0dda06fcf8b03150bc4d0deb668"
)
...
RUNNER_PATH = (
    ...
    / "app"
    / "adaptation"
    / "greenhouse_final_acceptance_runner_v0_4_v0_3.py"
)
...
def validate_rebound_execution_authorization(
    *,
    ...
    if not authorization_path.is_file():
        ...
        raise RuntimeError(
            (
                ...
                "v0.2 is missing. Official execution remains blocked."
            )
        )
    ...
    if (
        ...
        !=
        "qlora_v0.4_greenhouse_final_acceptance_execution_authorization_v0.2"
    ):

        raise RuntimeError(
            "Expected rebound Execution Authorization v0.2."
        )
