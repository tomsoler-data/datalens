...
GREENHOUSE_FINAL_ACCEPTANCE_RUNNER_RULE_VERSION = (
    "qlora_v0.4_greenhouse_final_acceptance_runner_v0.3"
)
...
def generate_label_blind_case_from_user_message(
    *,
    model: Any,
    tokenizer: Any,
    user_message: str,
...
def generate_label_blind_case(
    *,
    ...
    return generate_label_blind_case_from_user_message(
        model=
            model,
        tokenizer=
            tokenizer,
...
# IMPORTANT
# ------------------------------------------------------------
# This v0.3 source deliberately contains no function that opens
