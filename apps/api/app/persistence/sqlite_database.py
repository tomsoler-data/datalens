...
def _apply_schema_migrations(
    ...
    with _SCHEMA_LOCK:
        ...
        # ====================================================
        # SQLITE_SCHEMA_V13_ML_PERFORMANCE_EVALUATION
        # ML_PERFORMANCE_EVALUATION_STORE_V0_1
        # ====================================================
            ...
            try:
                connection.execute(
                    ...
                    ml_performance_evaluations (
                        ...
                        degradation_basis TEXT NOT NULL
                            CHECK (
                                degradation_basis
                                IN (
                                    'absolute_points',
                ...
                connection.execute(
                    """
                    CREATE INDEX IF NOT EXISTS
                    idx_ml_performance_evaluations_scope_workflow

                    ON ml_performance_evaluations (
                        store_root,
                        workflow_id,
                        evaluated_at_utc,
                        performance_evaluation_id
                ...
                connection.execute(
                    """
                    CREATE INDEX IF NOT EXISTS
                    idx_ml_performance_evaluations_scope_model
                ...
                connection.execute(
                    """
                    CREATE INDEX IF NOT EXISTS
                    idx_ml_performance_evaluations_observed_dataset
                ...
                connection.execute(
                    """
                    CREATE INDEX IF NOT EXISTS
                    idx_ml_performance_evaluations_observed_revision
        ...
        # ====================================================
        # SQLITE_SCHEMA_V14_ML_MODEL_ARTIFACT_MULTI_FORMAT
        # ML_MODEL_ARTIFACT_MULTI_FORMAT_V0_1
        # ====================================================
        ...
        if (
            ...
            #
            # ml_model_artifacts is also a referenced parent
            # table, so its reconstruction must preserve child
            # foreign-key targets and rows.
            #
            # foreign_keys must be disabled OUTSIDE the
