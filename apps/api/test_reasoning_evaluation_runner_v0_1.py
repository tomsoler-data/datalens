...
from app.adaptation.reasoning_evaluation_runner import (
    ADAPTER_PATH,
    CASES_PATH,
...
print(
    "=== DATALENS REASONING EVALUATION RUNNER v0.1 ==="
)
...
assert (
    REASONING_EVALUATION_RUNNER_RULE_VERSION
    ==
    "adapted_reasoning_evaluation_runner_v0.1"
)

assert (
    REASONING_EVALUATION_MANIFEST_RULE_VERSION
    ==
    "adapted_reasoning_evaluation_manifest_v0.1"
)

assert (
    REASONING_EVALUATION_RECEIPT_RULE_VERSION
    ==
    "adapted_reasoning_evaluation_receipt_v0.1"
)
...
runner_path = (
    ...
    / "app"
    / "adaptation"
    / "reasoning_evaluation_runner.py"
)
...
print(
    "DATALENS REASONING EVALUATION RUNNER v0.1: PASS"
)
