...
from app.deep_learning.time_series_rnn_executor import (
    DL_TIME_SERIES_RNN_EXECUTOR_RULE_VERSION,
...
# ============================================================
# 1. COMMON A1-A5 FORECAST POPULATION
# ============================================================


forecast_contract = (
    MLTimeSeriesForecastingContract(
        workflow_id="workflow:rnn",
        dataset_id="dataset:rnn",
...
print(
    "[PASS] RNN consumes the exact common forecasting population"
)
...
print(
    "[PASS] RNN capacity is explicit and bounded"
)


# ============================================================
# 3. GENUINE RNN NETWORK
# ============================================================


network = TimeSeriesRNNRegressor(
    lookback=4,
    hidden_size=12,
)
...
print(
    "[PASS] lookback is interpreted as an ordered RNN sequence"
)
...
result = execute_time_series_rnn(
    windows=windows,
...
print(
    "[PASS] simple RNN trains through shared DL-2 authorities"
)


# ============================================================
# 5. SAME TEST POPULATION / METRICS
# ============================================================
...
print(
    "[PASS] RNN uses exact TEST targets and shared metrics"
)
...
print(
    "[PASS] RNN reuses exact TRAIN-only scaling"
)
...
replay = execute_time_series_rnn(
    windows=windows,
    hyperparameters=hyperparameters,
    execution_device="cpu",
)
...
print(
    "[PASS] fixed server seed reproduces exact CPU RNN execution"
)
...
mutated_result = execute_time_series_rnn(
...
print(
    "[PASS] TEST targets affect evaluation only, never prediction"
)
...
if torch.cuda.is_available():
    ...
    cuda_result = execute_time_series_rnn(
        windows=windows,
    ...
    print(
        "[PASS] optional CUDA RNN execution"
    )

else:

    print(
        "[SKIP] CUDA unavailable; CPU RNN authority validated"
    )
...
print(
    "[PASS] temporal hyperparameter contract remains torch-free"
)


print()
print("=" * 80)
print("DL-5-A7-V1 FINAL VERDICT")
print("=" * 80)
print()

print("Genuine torch.nn.RNN                      PASS")
...
print()
print(
    "DL-5-A7-V1 - SIMPLE RNN CORE: PASS"
)
